...
active proctype Maquina() {
    ...
    assert(caja == (10-stockLeche) * 75 + (5-stockPuro) * 100);
    assert(presupuesto + caja==1500)
        if
...
active proctype Cliente() {
    ...
    :: 
        if
        :: (presupuesto > 75 && monedas!75;   // Cliente inserta 75 céntimos para chocolate con leche
            ...
            presupuesto = presupuesto - 75; //Resto el gasto del presupuesto
        :: (presupuesto > 100 && monedas!100);  // Cliente inserta 1 euro para chocolate puro
            ...
            presupuesto = presupuesto - 100; //Resto el gasto del presupuesto
        fi
    od
}